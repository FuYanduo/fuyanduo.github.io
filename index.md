...
🎯 My research interests mainly include identity authentication, password managers, and end-to-end testing. 
Additionally, I'm currently intrigued by the fields of empirical studies and digital forensics. 
I aspire to leverage technical skills to safeguard the security of the internet and the privacy of users.

✨ In life, I prefer to engage in some gentle exercises, such as basketball, yoga, strength training, jogging, reading, and listening to the same piece of music repeatedly. 
I also occasionally play single-player games (e.g., NBA 2K series).
Lately, for health reasons, I’ve taken a break from weight training and begun to explore forms of movement that help me better understand and control my body, such as indoor climbing, running, swimming, yoga, and functional training.
...
- **2026.03** The Final Year! Everything will be ok. ☘️
- **2024.12** A Long Journey to Hawaii, USA
- **2024.09** A paper on password managers' protocol analysis is accepted by IEEE S&P 2025! Congratulations to [my colleagues](https://danielnku.github.io/). 🥳🎉
- **2024.08** A paper on password managers' autofill features is accepted by ACSAC 2024! 🥳🎉
